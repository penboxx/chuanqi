 ...
 * 最后修正：2010-6-29
 **/
var IMAGESPATH = '/Dialog/images/'; //图片路径配置，如在有iframe情况下使用，此路径为最顶层窗口页面的相对路径
...
var Dialog = function () {
    ...
    this.MessageIcon = "images/window.gif";
    this.MessageTitle = "";
    this.Message = "";
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_{thisID}" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: -moz-none; font-size:12px; line-height:1.4;border-collapse: collapse;">\
    <tr id="_Draghandle_{thisID}" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" style="background-image: url(images/{IMAGESPATH}dialog_lt.png) !important;background: url(images/{IMAGESPATH}dialog_lt.gif) no-repeat 0 0;"><div style="width: 13px;"></div></td>\
      <td height="33" style="background-image:url(images/{IMAGESPATH}dialog_ct.png) !important;background: url(images/{IMAGESPATH}dialog_ct.gif) repeat-x top;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><img align="absmiddle" src="images/{IMAGESPATH}icon_dialog.gif"/><span id="_Title_{thisID}">' + this.Title + '</span></div>\
        <div id="_ButtonClose_{thisID}" onclick="Dialog.getInstance(\'{thisID}\').cancelButton.onclick.apply(Dialog.getInstance(\'{thisID}\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(images/{IMAGESPATH}dialog_closebtn.gif)\'" onmouseover="this.style.backgroundImage=\'url(images/{IMAGESPATH}dialog_closebtn_over.gif)\'" style="margin: 4px 0 0;*margin-top: 5px; position: relative;top:auto; cursor: pointer; float: right; height: 17px; width: 28px; background: url(images/{IMAGESPATH}dialog_closebtn.gif) 0 0;' + (ielt7 ? "margin-top: 3px;" : "") + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      <td width="13" height="33" style="background-image: url(images/{IMAGESPATH}dialog_rt.png) !important;background: url(images/{IMAGESPATH}dialog_rt.gif) no-repeat right 0;"><div style="width: 13px;"><a id="_forTab_{thisID}" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
      <td width="13" style="background-image: url(images/{IMAGESPATH}dialog_mlm.png) !important;background: url(images/{IMAGESPATH}dialog_mlm.gif) repeat-y left;"></td>\
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
          <tr id="_MessageRow_{thisID}" style="' + (this.ShowMessageRow ? "" : "display:none") + '">\
            <td valign="top" height="50"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#eaece9 url(images/{IMAGESPATH}dialog_bg.jpg) no-repeat scroll right top;" id="_MessageTable_{thisID}">\
                <tr>\
	...
	' + (function (obj) {
      ...
      <td width="13" style="background-image: url(images/{IMAGESPATH}dialog_mrm.png) !important;background: url(images/{IMAGESPATH}dialog_mrm.gif) repeat-y right;"></td>\
    </tr>\
    <tr>\
      <td width="13" height="13" style="background-image: url(images/{IMAGESPATH}dialog_lb.png) !important;background: url(images/{IMAGESPATH}dialog_lb.gif) no-repeat 0 bottom;"></td>\
      <td style="background-image: url(images/{IMAGESPATH}dialog_cb.png) !important;background: url(images/{IMAGESPATH}dialog_cb.gif) repeat-x bottom;"></td>\
      <td width="13" height="13" style="background-image: url(images/{IMAGESPATH}dialog_rb.png) !important;background: url(images/{IMAGESPATH}dialog_rb.gif) no-repeat right bottom;"><a onfocus=\'getDom("_forTab_{thisID}").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
';
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="images/' + IMAGESPATH + 'icon_alert.gif" width="34" height="34" align="absmiddle"></td>\
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td align="right"><img id="Icon_' + this.ID + '" src="images/' + IMAGESPATH + 'icon_query.gif" width="34" height="34" align="absmiddle"></td>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:9pt">' + msg + '</td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
